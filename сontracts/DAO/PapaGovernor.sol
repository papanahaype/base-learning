    ...
    GovernorTimelockControl
{
    constructor(
        ...
        Governor("PapaGovernor")
        GovernorSettings(
            1,          // задержка перед началом голосования: 1 блок
            1800,         // продолжительность голосования: 50 блоков
            100 ether   // минимум 100 PGT для создания предложения
        )
        GovernorVotes(token)
